...
class categories(models.Model):
    ...
    category_logo = models.ImageField(
        default="default.png", upload_to="images")
...
class payment(models.Model):
    modelname = models.ForeignKey(
        items, on_delete=models.DO_NOTHING, related_name='pay_model', null=True, blank=True)
    price = models.ForeignKey(items, on_delete=models.DO_NOTHING,
                              related_name='pay_price', null=True, blank=True)
